...
/*************************/
__flash uchar MenuAllFreq0[] = "-500 Гц";
__flash uchar MenuAllFreq1[] = "-250 Гц";
__flash uchar MenuAllFreq2[] = "+0 Гц";
__flash uchar MenuAllFreq3[] = "+250 Гц";
__flash uchar MenuAllFreq4[] = "+500 Гц";
...
// н	с		л	с	п
// параметры защиты
__flash strParam paramDef[] =
{
	0,	7,		1,	1,	1,		// тип защиты
	2,	3,		1,	1,	2,		// тип линии
	0,	99,		1,	1,	2,		// доп время без манипуляции
	0,	18,		1,	1,	2,		// задержка на линии
	0,	54,		1,	1,	2,		// перекрытие импульсов
	0,	22,		1,	1,	2,		// загр. чувств. по РЗ
	0,	1,		1,	1,	2,		// снижение уровня АК
	0,	4,		1,	1,	1,		// частота ПРД
	0,	4,		1,	1,	1,		// частота ПРМ
	0,	9,		1,	1,	0		// автоконтроль, всегда в конце
};
...
{
	0,	10,		1,	1,	2,		// задержка на включение
	1,	50,		10,	1,	2,		// длительность команды
	1,	50,		10,	1,	2,		// задержка на выключение
...
// н	с		л	с	п
// параметры общие
__flash strParam paramGlb[] =
{
	0,	4,		1,	1,	1,		// тип уд.аппарата	
	0,	1,    	1,	1,	1,		// синхронизация часов  
	8, 	50,    	1,	1,	2,  	// Uвых номинальное 
	0,  1,    	1,	1,	1,  	// удержание реле ПРД 
	0,  255,  	1,	1,	2,  	// сетевой адрес 
	0,  5,    	1,	1,	2,  	// время перезапуска  
	16, 998,  	1,	1,	2,  	// частота  
	1,  2,    	1,	1,	2,  	// номер аппарата  
	0,  1,   	1,	1,	1,  	// контроль выходного сигнала  
	0,  22,  	1,	1,	2,  	// порог предупреждения по КЧ  
	0,  22,   	1,	1,	2,  	// загрубление чувствительности по КЧ  
	0,  0x6309,	1,	1,	3,  	// коррекция напряжения  
	0,  999,	1,	1,	2,  	// коррекция тока 
	1,	2,		1,	1,	1,		// протокол обмена	
	1,	2,		1,	1,	1,		// признак четности	
	0,	180,	1,	1,	20,		// допустимые провалы	
	0,	255,	1,	1,	2,		// порог по помехе	
	18,	90,		1,	1,	2,		// допустимая помеха	
	1,	3,		1,	1,	1,		// тип автоконтроля	
	0,	1,		1,	1,	1,		// Резервирование (оптика)
	0, 	20,		1,	1,	2,		// снижение ответа АК (пвзл)
	0,	1,		1,	1,	1		// удержание реле ПРМ
};
