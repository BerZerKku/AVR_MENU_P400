...
__flash unsigned char ArchSob[][11] = {
    ...
    "Изм.режима", // 18
    "Н.цепи ВЫХ", // 19
    "Изм. парам", // 20 - Изменение параметров работы приемопередатчика
    "АК-сн.зап.", // 21
    "АК-нет отв", // 22
    "Нет с.ПУСК", // 23
    "нет с.СТОП", // 24
    ...
    "Дальний   ", // 36
    "Сбр.своего", // 37
    "Сбр.от уд.", // 38 - Сброс от удаленного
    "Сброс АК  ", // 39
    "Сбр.АК упр", // 40 - Сброс АК по входу Упр.1
    "Сбр АК уд.", // 41 - Сброс АК от удаленного
    "Пуск АК   " // 42
}
#endif
