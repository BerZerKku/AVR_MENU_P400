...
__flash unsigned char Menu102[]="Uвых номинальное";//"Увелич.вых.мощности"; //"Удержание реле ПРМ";
...
__flash uint RangGlb[NumParamGlb] [3] = {	
											0,	3,		1,		/*тип уд.аппарата	*/
                                            0,	1,    	1,		/*синхронизация часов  */
                                            18, 50,    	1,  	/*Uвых номинальное / удержание реле ПРМ  */
...
#define dNumSob 25
__flash unsigned char ArchSob[dNumSob] [11] ={	"Н.чт.FLASH",
												"Н.зп.FLASH",
												"Н.чт.PLIS ",
												"Н.зп.PLIS ",
												"Н.зп.2RAM ",
