...
static void FuncViewValue(uint8_t numparam)
{
    ...
    case 0x40: {
        if ((num == 3) || (num == 4))
            var = 0; //там где вводятся значения битовые 0-ками и 1-ами
        else if (num < NumParamPrm) {
            var = 2;
...
static void FuncInpCorrParam(void)
{
    ...
    if (PressKey == 'C') {
        ...
        LCDbufClMenu();
        LCD2new = 1;
        for (NumberInputChar = 0; NumberInputChar < 4; NumberInputChar++)
            InputValue[NumberInputChar] = 0x00;
        ValueVsRange = 0;
        NumberInputChar = 0x00;
        MaxNumberInputChar = 0x00;
        ByteShift = 0;
        MaxValue = 0;
        MinValue = 0;
    }
    ...
    if (PressKey == 'E') {
        if (InputParameter == 1) { //если вводим напряжение
            ...
            ii = (InputValue[0] & 0x0f) * 10;
            ii += InputValue[1] & 0x0F;
            ii *= 10;
        ...
        if ((ii < 1000) || (ii > -1000)) { //если получилось корректное значение
            ...
            for (NumberInputChar = 0; NumberInputChar < 5; NumberInputChar++)
                InputValue[NumberInputChar] = 0x00;
            WorkRate = 0x00;
            LCDbufClMenu();
            LCD2new = 1;
...
static void FuncInputDataTime(void)
{
            ...
            if (InputParameter == 1) {
                ...
                case 0: {
                    if (PressKey <= '3') {
                        ...
                        NumberInputChar++;
                        if (PressKey == '3')
                            InputDataTime[NumberInputChar] = '0';
                    }
                } break;
                case 1: {
                    if (InputDataTime[0] == '3') {
                        if (PressKey <= '1') {
                            InputDataTime[NumberInputChar] = PressKey;
                            NumberInputChar++;
                        }
            ...
            if (InputParameter == 2) {
                ...
                case 0: {
                    if (PressKey <= '2') {
                        ...
                        NumberInputChar++;
                        if (PressKey == '2') {
                            if (InputDataTime[1] > '3')
                                InputDataTime[NumberInputChar] = '0';
                        }
                    }
                } break;
                case 1: {
                    if (InputDataTime[0] == '2') {
                        if (PressKey < '4') {
                            InputDataTime[NumberInputChar] = PressKey;
                            NumberInputChar++;
                        }
    ...
    if ((PressKey == 'U') && (NumberInputChar < 7)) {
        NumberInputChar++;
        if (NumberInputChar == 2)
            NumberInputChar = 3;
        if (NumberInputChar == 5)
    ...
    if (PressKey == 'E') {
        if (InputParameter == 1) {
            ...
            if (TempValue < 32)
                TrDataTimeMass[2] = ((InputDataTime[0] - 0x30) << 4) + (InputDataTime[1] - 0x30);
            TempValue = (InputDataTime[3] - 0x30) * 10 + (InputDataTime[4] - 0x30);
            if (TempValue < 13)
                TrDataTimeMass[1] = ((InputDataTime[3] - 0x30) << 4) + (InputDataTime[4] - 0x30);
            TrDataTimeMass[0] = ((InputDataTime[6] - 0x30) << 4) + (InputDataTime[7] - 0x30);
        }
        if (InputParameter == 2) {
            TempValue = (InputDataTime[0] - 0x30) * 10 + (InputDataTime[1] - 0x30);
            if (TempValue < 24)
                TrDataTimeMass[3] = ((InputDataTime[0] - 0x30) << 4) + (InputDataTime[1] - 0x30);
            TempValue = (InputDataTime[3] - 0x30) * 10 + (InputDataTime[4] - 0x30);
            if (TempValue < 60)
                TrDataTimeMass[4] = ((InputDataTime[3] - 0x30) << 4) + (InputDataTime[4] - 0x30);
            TempValue = (InputDataTime[6] - 0x30) * 10 + (InputDataTime[7] - 0x30);
            if (TempValue < 60)
                TrDataTimeMass[5] = ((InputDataTime[6] - 0x30) << 4) + (InputDataTime[7] - 0x30);
        }
        NewTime = 1;
        WorkRate = 0x00;
        NumberInputChar = 0;
...
static void FuncInputData(void)
{
    ...
    if (NumberInputChar < MaxNumberInputChar) //если кол-во введеных символов еще меньше максимальновозможного
        if ((InputParameter == 14) || (InputParameter == 15) || (InputParameter == 20) || (InputParameter == 21)) { //т.е. вводим пар-р из 0 и 1
            if ((PressKey == '0') || (PressKey == '1')) {
                InputValue[NumberInputChar] = PressKey;
                NumberInputChar++;
            }
        } else if ((PressKey >= '0') && (PressKey <= '9')) { //реакция на нажатие цифры
            InputValue[NumberInputChar] = PressKey;
            NumberInputChar++;
        }
    ...
    if (PressKey == 'C') {
        ...
        if ((bDef) && (CurrentState[0] == 2))
            EntPass = 0;
        if ((cNumComR > 0) && ((CurrentState[2] == 1) || (CurrentState[2] == 2)))
            EntPass = 0;
        if ((cNumComT > 0) && (CurrentState[4] == 2))
            EntPass = 0;
    ...
    if (((InputParameter == 14) || (InputParameter == 15) || (InputParameter == 20) || (InputParameter == 21)) && (NumberInputChar == MaxNumberInputChar) && (PressKey == 'E')) {
        ...
        LCD2new = 1;
        TempValue = 0;
        if (MaxNumberInputChar == 8)
            TempValue = ((InputValue[0] - 0x30) * 128) + ((InputValue[1] - 0x30) * 64) + ((InputValue[2] - 0x30) * 32) + ((InputValue[3] - 0x30) * 16) + ((InputValue[4] - 0x30) * 8) + ((InputValue[5] - 0x30) * 4) + ((InputValue[6] - 0x30) * 2) + ((InputValue[7] - 0x30));
        if (MaxNumberInputChar == 4)
            TempValue = ((InputValue[0] - 0x30) * 8) + ((InputValue[1] - 0x30) * 4) + ((InputValue[2] - 0x30) * 2) + ((InputValue[3] - 0x30));
        ControlParameter = 1;
        TrValue = TempValue;
        if ((InputParameter == 14) || (InputParameter == 15))
            TrParam = InputParameter - 10;
        if ((InputParameter == 20) || (InputParameter == 21))
            TrParam = InputParameter - 16;
        // очищаем буферный массив
        for (NumberInputChar = 0; NumberInputChar < 8; NumberInputChar++)
            InputValue[NumberInputChar] = 0x00;
        NumberInputChar = 0x00;
        MaxNumberInputChar = 0x00;
        ByteShift = 0;
    ...
    if ((PressKey == 'E') && (MenuLevel != LVL_MENU) && (MenuLevel != LVL_SETUP) && (MenuLevel != LVL_REGIME) && (InputParameter != 14) && (InputParameter != 15) && (InputParameter != 20) && (InputParameter != 21)) {
        WorkRate = 0x00;
        LCDbufClMenu();
        LCD2new = 1;
        ...
        if (ControlParameter == 1) {
            ...
            case 25:
            case 26: {
                TrParam = InputParameter - 21;
                TrValue = TempValue;
            } break;
            case 27: {
                TrParam = 6;
                TrValue = TempValue;
            } break; //параметр поста/напряжение порога
            case 28: {
                TrParam = InputParameter - 22;
                TrValueD = TempValueD;
            } break;
            case 29: {
                TrParam = InputParameter - 22;
            ...
            case 30: {
                TrParam = 8;
                TrValue = TempValue;
            } break; //параметр прм/напряжение порога
            case 35: {
                TrParam = 5;
                TrValue = TempValue;
            } break;
            ...
            case 0xB6: {
                TrParam = 2;
                TrValue = TempValue;
            } break; //параметр общий , Uвых номинальное
            }
            InputParameter = 0;
            ControlParameter = 0;
        }
    ...
    if ((PressKey == 'E') && (NumberInputChar == 4) && ((PressPassword == 1) || (PressPassword == 2)) && ((MenuLevel == LVL_SETUP) || (MenuLevel == LVL_REGIME))) {
        WorkRate = 0x00;
        LCDbufClMenu();
        LCD2new = 1;
        ...
        if (PressPassword == 2) {
            ...
            NumberInputChar = 0;
            for (PressPassword = 0; PressPassword < 4; PressPassword++)
                if (InputValue[PressPassword] != ePassword[PressPassword])
                    NumberInputChar++;
            //если пароль не совпал с пользовательским, сравним его с постоянным
            if (NumberInputChar != 0) {
                NumberInputChar = 0;
                for (PressPassword = 0; PressPassword < 4; PressPassword++)
                    if (InputValue[PressPassword] != Password[PressPassword])
                        NumberInputChar++;
            }
            //если пароль верен
            //**************/ NumberInputChar =0;
            ...
            //ввели новый пароль
            if (PressPassword == 1) {
                ePassword[0] = InputValue[0];
                ePassword[1] = InputValue[1];
                ePassword[2] = InputValue[2];
                ePassword[3] = InputValue[3];
...
static void FuncPressKey(void)
{
    ...
    case '2': {
        switch (MenuLevel) {
        case LVL_START: { //прокрутка измеряемых параметров
            if (cTypeLine == 1) {
                do {
                    if (NumberAskMeasuring > 1)
                        NumberAskMeasuring--;
                    else
                        NumberAskMeasuring = 16;
    ...
    case '4': {
        ...
        case LVL_PRM_VIEW:
        case LVL_PRM_SETUP: { //уменьшение номера команды,для приемника
        ...
        case LVL_PRD_VIEW:
        case LVL_PRD_SETUP: { //уменьшение номера команды, для передатчика
            if ((ShiftMenu == 3) || (ShiftMenu == 4)) {
                if (cNumComT > 8) {
    ...
    case '6': {
        ...
        case LVL_DEF_VIEW:
        case LVL_DEF_SETUP: { //выбор номера в параметрах Поста, для 3-х концевой линии
            //					if (cNumLine==3)
            //					{
        ...
        case LVL_PRM_VIEW:
        case LVL_PRM_SETUP: { //меню параметров приемника
            unsigned char tNumComR;
        ...
        case LVL_PRD_VIEW:
        case LVL_PRD_SETUP: { //меню параметров передатчика
            if ((ShiftMenu == 3) || (ShiftMenu == 4)) {
                if (cNumComT > 8) {
                    if (NumberCom < (cNumComT / 8))
                        NumberCom++;
                    else
                        NumberCom = 1;
                    LCDbufClMenu();
    ...
    case '8': {
        if (MenuLevel == LVL_START) { //прокрутка измеряемых параметров
            if (cTypeLine == 1) {
                do {
                    NumberAskMeasuring++;
    ...
    case 'C': {
        ...
        case LVL_MENU:
            Menu_Start();
            break; //возврат в начальное меню
        ...
        case LVL_GLB_VIEW:
            Menu_ParamSetup(LVL_PARAM_VIEW);
            break; //возврат в Просмотр параметров

        case LVL_TEST:
        case LVL_REGIME:
        case LVL_PARAM_SETUP:
            Menu_Setup();
            break; //возврат в Мменю/утсановить
        ...
        case LVL_GLB_SETUP:
            Menu_ParamSetup(LVL_PARAM_SETUP);
            break; //Возврат в Устанновить\Параметры

        case LVL_JRN_VIEW:
            Menu_Journal();
            break; //возврат в меню Журнал
        }
    } break;
    ...
    case 'D': {
        switch (MenuLevel) {
        case LVL_START: { //прокрутка меню, если 3-х концевая и все 4 устройства
            if (bAllDevice) {
                if (ShiftMenu == 0)
                    ShiftMenu = 1;
            }
    ...
    case 'E': {
        ...
        case LVL_START: {
            if (bDef) {
                ...
                } else if ((TypeUdDev == 3) || (TypeUdDev == 4) || (TypeUdDev == 7) || (TypeUdDev == 8)) {
        ...
        case LVL_REGIME: { //ввод режимов работы
            if ((PressPassword == 2) && (EntPass == 0)) {
                ...
                if (PressPassword == 1) {
                    bInpVal = false;
                    if ((bDef) && ((CurrentState[0] == 2) || (CurrentState[0] == 0x4E)))
                        bInpVal = true;
                    if ((cNumComR > 0) && ((CurrentState[2] == 2) || (CurrentState[2] == 1) || (CurrentState[2] == 0x4E)))
                        bInpVal = true;
                    if ((cNumComT > 0) && ((CurrentState[4] == 2) || (CurrentState[4] == 0x4E)))
                        bInpVal = true;
                    if (bInpVal) {
                        WorkRate = 2;
                        SelectValue = 1;
                        InputSelectValue = 0;
                        MaxValue = 1;
                        MinValue = 0; /*MaxSelectValue=1;MinSelectValue=0;*/
                        MassSelectValue = Menu1regimeInp;
                        PressPassword = 2;
                    } else {
                        WorkRate = 2;
                        SelectValue = 1;
                        InputSelectValue = 0;
                        MinValue = 0; /*MinSelectValue=0;*/
                        MassSelectValue = Menu1regimeInp2;
                        PressPassword = 2;
                        if ((cNumComT > 0) || (bDef))
                            MaxValue = 3; //MaxSelectValue=3;
                        else
                            MaxValue = 2; //MaxSelectValue=2;  //а вот тут надо предусмотреть, что в отсутствии ПРД и Пост, можно войти в ТЕст2 и нельзя в Тест1.
                    }
                    EntPass = 0;
                } else {
                    bInpVal = false;
                    ...
                    if (bInpVal) {
                        ...
                        PressPassword = 2;
                        if ((cNumComT > 0) || (bDef))
                            MaxValue = 2; //MaxSelectValue=2;
                        else
                            MaxValue = 1; //MaxSelectValue=1; //а вот тут надо предусмотреть, что в отсутствии ПРД и Пост, можно войти в ТЕст2 и нельзя в Тест1.
                    }
                    EntPass = 0;
                }
            }
        ...
        case LVL_DEF_SETUP: { //ввод параметров в меню Установить\Параметры\Пост
            if (CurrentState[0] == 0x00) {
                ...
                case 0: {
                    ...
                    SelectValue = 1;
                    InputSelectValue = 0;
                    MassSelectValue = MenuTypeDefendNum;
                } break;
                case 1: {
                    WorkRate = 0x01;
                    MaxNumberInputChar = 1;
                    ByteShift = 0;
                    InputParameter = 7;
                    Discret = 1;
                } break;
        ...
        case LVL_PRM_SETUP: { //ввод параметров в меню Установить\Параметры\Приемник
            if (CurrentState[2] == 0x00) {
                switch (ShiftMenu) {
                case 0: {
                    WorkRate = 0x01;
                    MaxNumberInputChar = 2;
                    ByteShift = 0; /*MaxValue=10;MinValue=0;*/
                    InputParameter = 11;
                    Discret = 1;
                } break;
                case 1: {
                    ...
                    ByteShift = 0; /*MaxValue=500;MinValue=10;*/
                    InputParameter = 12;
                    Discret = 10;
                } break;
                case 2: {
                    WorkRate = 0x01;
                    MaxNumberInputChar = 4;
                    ByteShift = 0; /*MaxValue=1000;MinValue=0;*/
                    InputParameter = 13;
                    Discret = 10;
                    NumberTransCom = NumberCom;
                } break;
                case 3: {
                    WorkRate = 0x01;
                    ByteShift = 0; /*MaxValue=9999;MinValue=0;*/
                    InputParameter = 14;
                    Discret = 1;
                    NumberTransCom = NumberCom;
                    if (cNumLine == 2)
                        if (cNumComR > 4)
                            MaxNumberInputChar = 8;
                        else
                            MaxNumberInputChar = 4;
                    else if (cNumPrm == 1)
                        if (cNumComR1 > 4)
        ...
        case LVL_PRD_SETUP: { //ввод параметроа Установить\Параметры\Передатчик
            if (CurrentState[4] == 0x00) {
                ...
                case 2: {
                    WorkRate = 0x01;
                    MaxNumberInputChar = 3;
                    ByteShift = 0; /*MaxValue=50;MinValue=10;*/
                    InputParameter = 19;
                    Discret = 10;
                } break;
                case 3: {
        ...
        case LVL_GLB_SETUP: { //меню/установить/параметры/общие
        ...
        case LVL_TEST: {
            ...
            if (((cNumComT > 0) && (CurrentState[4] == 0x05)))
                break;
            if (((bDef) && (CurrentState[0] == 0x05)))
                break;
    ...
    if (ModBusBaza->status(0) != 2) {
        if (ReadArch == 0) { //проверяем идет ли считывание архива
            ...
            if (PosModBusInfill < 0x10) { //Общие параметры
                ...
                case 1:
                case 2: {
                    TransDataInf(0x30 - 1 + PosModBusInfill, 0x00);
                } break;
                case 3:
                case 4:
                case 5:
                case 6:
                case 7: {
                    TransDataInf(0x30 + 2 + PosModBusInfill, 0x00);
                } break;
                case 8: {
                    TransDataInf(0x3D, 0x00);
                } break;
                case 9: {
                    TransDataInf(0xF1, 0x00);
                } break;
                case 10: {
                    TransDataInf(0x33, 0x00);
                } break; // опрос коррекции тока/напряжени или параметров ВОЛС
                default:
                    PosModBusInfill = 0x10;
                }
            }
            if ((PosModBusInfill >= 0x10) && (PosModBusInfill < 0x20)) //параметры УМ
            {
                if (cTypeLine == 1) { //если свзяь по ЛЭП
                    switch (PosModBusInfill) {
                    case 0x10: {
                    ...
                    case 0x11:
                    case 0x12: {
                        TransDataInf(0x30 + PosModBusInfill - 7, 0x00);
                    } break;
                    default:
            ...
            if ((PosModBusInfill >= 0x20) && (PosModBusInfill < 0x30)) //параметры Защиты
            {
                if (bDef) {
                    ...
                    case 0x25:
                    case 0x26: {
                        TransDataInf(0x01 + PosModBusInfill - 0x20, 0x00);
                    } break;
                    case 0x27: {
                        TransDataInf(0xC1, 0x00);
                    } break;
                    case 0x28: {
                        TransDataInf(0x0A, 0x00);
                    } break; //опрос скорости автоконтроля
                    default:
                        PosModBusInfill = 0x30;
                    }
                } else
                    PosModBusInfill = 0x30;
            }
            ...
            if (PosModBusInfill >= 0x30) { //параметры ПРМ и ПРД
                if ((cNumComR1 == 0) && (PosModBusInfill < 0x36))
                    PosModBusInfill = 0x40; //если нет ПРМ1
                if ((cNumComR2 == 0) && (PosModBusInfill == 0x36))
                    PosModBusInfill = 0x40; //если нет ПРМ2
                if ((cNumComT == 0) && (PosModBusInfill > 0x3F))
                    PosModBusInfill = 0x00; //если нет ПРД
                ...
                case 0x33:
                case 0x34: {
                    TransDataInf(0x11 + PosModBusInfill - 0x30, 0x00);
                } break; //параметры ПРМ
                case 0x35: {
                    TransDataInf(0xD1, 0x00);
                } break; //кол-во записей в архиве ПРМ
                case 0x36:
                case 0x37:
                case 0x38:
                case 0x39:
                case 0x3A: {
                    TransDataInf(0x18 + PosModBusInfill - 0x36, 0x00);
                } break; //параметры второго ПРМ
                case 0x3B:
                    PosModBusInfill = 0x40;
                case 0x40:
                case 0x41:
                case 0x42:
                case 0x43:
                case 0x44: {
                    TransDataInf(0x21 + PosModBusInfill - 0x40, 0x00);
                } break;
                case 0x45: {
                    TransDataInf(0xE1, 0x00);
                } break; //параметры ПРД
                default:
                    PosModBusInfill = 0x00;
                }
            }
        } else {
...
void FuncTr(void)
{
    if (PCready == 0) { //связь с БСП
        if (RecivVar == 0) {
            if (NumberLostLetter < 5)
                NumberLostLetter++; //если у нас меньше 5 потерянных посылок, то увеличим счетчик
        } else {
            NumberLostLetter = 0;
            RecivVar = 0;
        } //иначе пишем в потерянные посылки 0 и обнуляем переменную полученных данных
        ...
        if (bReadVers) { //если версия аппарата считана
            if (LoopUART == 1) //опрашиваем примерно раз в 1сек
            {
                ...
                if (NewTime == 1) {
                    for (NewTime = 0; NewTime < 6; NewTime++)
                        Tr_buf_data_uart[4 + NewTime] = TrDataTimeMass[NewTime];
                ...
                } else //посылаем запрос дата/время либо частота/номер аппарата
                {
                    ...
                    if ((bDef) && (sArchive.NumDev == 1)) //если только пост, будем постоянно опрашивать время. Остальные параметры и так опрашиваются достаточно часто
                        ...
                        else if (LCDtimer == 3) { // опрос частоты и номера аппарата
                        ...
                        } else if (LCDtimer == 4) //опрос режима автоконтроля
                            TransDataInf(0x0A, 0x00);
                    }
                }
            } else if (LoopUART == 2) { //опрашиваем примерно раз в 0.5 сек
            ...
            } else if ((LoopUART == 3) || (LoopUART == 7)) //опрашиваем примерно раз в 0.5 сек
            {
                ...
                switch (DopComTrans) {
                case 1: {
                    TransDataInf(0x51, 0x00);
                    DopComTrans = 0;
                } break; //если нажали на кнопку ПУСК Приемника
                case 2: {
                    TransDataInf(0x9A, 0x00);
                    DopComTrans = 3;
                } break; //сброс индикации ПРМ
                case 3: {
                    TransDataInf(0xAA, 0x00);
                    DopComTrans = 0;
                } break; //сброс индикации ПРД
                case 4: {
                    TransDataByte(0x8A, 0x06);
                    DopComTrans = 0;
                } break; // АК запрос
                case 5: {
                    TransDataByte(0x72, 0x0F);
                    DopComTrans = 0;
                } break; // АК сброс
                case 6: {
                    TransDataByte(0x8A, 0x07);
                    DopComTrans = 0;
                } break; // АК пуск
                default:
                    TransDataByte(0x34, 0x00); //всегда опрашиваем все измеряемые параметры
                }
...
static void LCDMenu1(uint8_t NumString, uint8_t Device)
{
    ...
    if (Device == 1) {
        ...
        DevAvar = bDefAvar;
        DevWarn = bDefWarn;
    } else if ((Device == 2) || (Device == 5)) { //приемники
...
static void LCDwork(void)
{
    if (PCready == 0) {
        ...
        if (NumberLostLetter > 4) { //если было не принято 5 посылок подряд, то выводим на экран аварию
            ...
            if (LoopUART == 1)
                LCDprintf(1, 1, LCDavarNoUSP, 1); //выводим на экран сообщение "Нет связи с USP"
        } else if ((NumberLostLetter < 5) && (AvarNoUsp == 1)) { //если же у нас наконец-то была получена посылка от USP
        ...
        if (bReadVers) //если считана версия
        {
            ...
            case LVL_DEF_VIEW:
            case LVL_DEF_SETUP: { //меню/просмотр(установить) параметров/Защита
                if (LCD2new == 1) {
            ...
            case LVL_GLB_VIEW:
            case LVL_GLB_SETUP: { //меню/просмотр параметров(установить/параметры)/общие
                if (LCD2new == 1) {
                    ...
                    if (ValueVsRange == 0) {
                        ...
                        switch (sMenuGlbParam.punkt[ShiftMenu]) {
                        case 0:
                            LCDprintf(3, 11, fmTypeUdDev[TypeUdDev], 1);
                            break;
                        case 1:
                            LCDprintf(3, 11, MenuAllSynchrTimerNum[MenuAllSynchrTimer], 1);
                            break;
                        case 2:
                            LCDprint(3, 11, MenuAllKeepComPRM, 1);
                            break;
                        case 3:
                            LCDprintf(3, 11, MenuAllSynchrTimerNum[MenuAllKeepComPRD], 1);
                            break;
                        case 4:
                            LCDprint(3, 11, MenuAllLanAddress, 1);
                            break;
                        case 5:
                            LCDprint(3, 11, MenuAllTimeRerun, 1);
                            break;
                        case 6:
                            LCDprint(3, 11, MenuAllFreq, 1);
                            break;
                        case 7:
                            LCDprint(3, 11, MenuAllNumDevice, 1);
                            break;
                        case 8:
                            LCDprintf(3, 11, MenuAllSynchrTimerNum[MenuAllControlUout], 1);
                            break;
                        case 9:
                            LCDprint(3, 11, MenuAllCF, 1);
                            break; //Порог КЧ
                        case 10:
                        ...
                        case 11:
                        case 12:
                            LCDprint(3, 11, sCorrParam[sMenuGlbParam.punkt[ShiftMenu] + NumberCom - 12].Print, 1);
                            break; //коррекция напряжения и тока
                        // ПВЗУ-Е
                        case 13:
                            LCDprintf(3, 11, MenuAllProtocolNum[sParamPVZE.protocol], 1);
                            break;
                        case 14:
                            LCDprintf(3, 11, MenuAllParityNum[sParamPVZE.parity], 1);
                            break;
                        case 15:
                            LCDprint(3, 11, sParamPVZE.proval, 1);
                            break;
                        case 16:
                            LCDprint(3, 11, sParamPVZE.porog, 1);
                            break;
                        case 17:
                            LCDprint(3, 11, sParamPVZE.noise, 1);
                            break;
                        case 18:
                            LCDprintf(3, 11, MenuAllControlNum[sParamPVZE.autocontrol], 1);
                            break;
                        case 19:
                            LCDprintf(3, 11, MenuAllSynchrTimerNum[sParamOpt.reserv], 1);
                            break;
                        case 20:
                            LCDprint(3, 11, MenuAllLowCF, 1);
                            break;
                        case 21:
                            LCDprint(3, 11, sParamPVZE.periodAC, 1);
                            break;
                        case 22:
                            LCDprint(3, 11, sParamPVZE.periodACre, 1);
                            break;
                        case 23:
                            LCDprint(3, 11, sParamPVZE.timeCorrAC, 1);
                            break;
                        // Р400
                        case 24:
                            LCDprint(3, 11, MenuAllLowCFa, 1);
                            break;
                        }
                    } else {
                        LCDprintf(3, 1, ParamRange, 1);
                ...
                if (LCD2new == 1) {
                    if (TestDelay == 0) {
                        ...
                        if (bAllDevice) {
                            ...
                            if (CurrentState[0] == 0x4E)
                                LCDprintf(2, 5, Menu11Err, 1);
                            else
                                LCDprintf(2, 5, Menu11var[CurrentState[0]], 1);
                            //ПРМ1
                            LCDprintf(2, 11, Menu1Rec1, 1);
                            if (CurrentState[2] == 0x4E)
                                LCDprintf(2, 15, Menu11Err, 1);
                            else
                                LCDprintf(2, 15, Menu11var[CurrentState[2]], 1);
                            //ПРД
                            LCDprintf(3, 1, Menu1Tran, 1);
                            if (CurrentState[4] == 0x4E)
                                LCDprintf(3, 5, Menu11Err, 1);
                            else
                                LCDprintf(3, 5, Menu11var[CurrentState[4]], 1);
                            //ПРМ2
                            LCDprintf(3, 11, Menu1Rec2, 1);
                            if (CurrentState[6] == 0x4E)
                                LCDprintf(3, 15, Menu11Err, 1);
                            else
                                LCDprintf(3, 15, Menu11var[CurrentState[6]], 1);
                        } else {
                            uint8_t i = 1; //выравнивание слева, при отсутствии одного или нескольких утсройств
                            if (bDef) {
                                LCDprintf(2, 2, Menu11d, 1);
                                if (CurrentState[0] == 0x4E)
                                    LCDprintf(3, 2, Menu11Err, 1);
                                else
                                    LCDprintf(3, 1, Menu11var[CurrentState[0]], 1);
                                i += 7;
                            }
                            if (cNumComR1 > 0) {
                                if (cNumLine == 2)
                                    LCDprintf(2, i + 1, Menu11r, 1);
                                else
                                    LCDprintf(2, i + 1, Menu11r1, 1);
                                if (CurrentState[2] == 0x4E)
                                    LCDprintf(3, i + 1, Menu11Err, 1);
                                else
                                    LCDprintf(3, i, Menu11var[CurrentState[2]], 1);
                                i += 7;
                            }
                            if (cNumComR2 > 0) {
                                ...
                                if (CurrentState[6] == 0x4E)
                                    ...
                                    LCDprintf(3, i, Menu11var[CurrentState[6]], 1);
                                i += 7;
                            }
                            if (cNumComT > 0) {
                                ...
                                if (CurrentState[4] == 0x4E)
                                    ...
                                    LCDprintf(3, i, Menu11var[CurrentState[4]], 1);
                            }
                        }
                    } else {
                ...
                if (sArchive.RecCount) { //если в архиве что-то есть, будем выводить записи
                    if (sArchive.Data[12]) { //если данные уже получены
                        ...
                        case 2: { //приемник
                            ...
                            mm = 0;
                            if (sArchive.Data[2] == 0) {
                                mm = ArchEvEnd;
                                i = 7;
                            } else if (sArchive.Data[2] == 1) {
                                mm = ArchEvStart;
                                i = 8;
                            }
                            ...
                            if ((sArchive.Data[1] == 0) || (sArchive.Data[1] > 32)) { //ошибочное значение команды
                                LCDprintHEX(3, i, sArchive.Data[1]);
                                i += 2;
                            } else {
                                LCDprintDEC(3, i, sArchive.Data[1]);
                                if (sArchive.Data[1] < 10)
                                    i += 1;
                                else
                                    i += 2;
                            }
                        ...
                        case 3: { //защита
                            ...
                            //состояние защиты
                            if (sArchive.Data[2] == 0)
                                mm = ArchEvV1; //перезапуск
                            else if (sArchive.Data[2] < 11)
                                mm = Menu1condPOST[sArchive.Data[2]];
                ...
                if ((LCDparam == 1) && (PCready == 0)) {
                    ...
                    if (((AvarNoUsp == 1) && (LoopUART == 5)) || (AvarNoUsp == 0))
                        if (MenuLevel != LVL_DATA_TIME) {
                            ...
                            if (cNumLine > 2) { //если трех-концевая линия, то выведем 1 или 2 перед Uк/Uз
                                //   if ((NumberAskMeasuring==4)||(NumberAskMeasuring==5)){  //1 перед Uз
                                //     LCDprintChar(1,12, NumberAskMeasuring-3 + 0x30);
                                //  }else
                                if ((NumberAskMeasuring >= 6) && (NumberAskMeasuring <= 13)) { //1 перед Uк
        ...
        } else if (((AvarNoUsp == 1) && (LoopUART == 5)) || (AvarNoUsp == 0)) {
...
__C_task main(void)
{
    for (unsigned i = 30000; i > 1; i--)
        ; //стратовая задержка, для того чтобы индикатор успел включиться
